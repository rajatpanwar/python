...
btnSub = tk.Button(text='-', command=sub, bg='red', fg='black', font=('helvetica', 11, 'bold'), width = 5)
...
btndiv = tk.Button(text='/', command=div, bg='red', fg='black', font=('helvetica',11, 'bold'), width = 5)
